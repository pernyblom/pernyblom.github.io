...
//    var titleFontFamily = "erica_oneregular";
//    var titleFontFamily = "fascinate_inlineregular";
//    var titleFontFamily = "press_start_2pregular";

    var titleExtra = {
        defaultFontSize: 100,
        html: [
            '<div class="title" >',
            '<span>Gravity Stunts</span>',
            '</div>'
        ]};

    MenuInfos[Menus.ABOUT_MENU] = {
        caption: "About",
        extra: [titleExtra],
        width: "25em",
        components: [
            {type: "text", texts: ["Made by Per Nyblom, krasse@outlook.com, for Ludum Dare #26"], width: "24em", fontSize: "0.8em"},
    ...
    MenuInfos[Menus.GAME_MENU] = {
        ...
        components: [
            ...
            {type: "button", text: "About", width: "10em", height: "2em",
                action: function() {
                    GameState.subState = GameSubState.SHOWING_ABOUT_MENU;
                }},
...
//        extra: [titleExtra],
        caption: "Pause",
        components: [
            {type: "button", text: "Resume", width: "20em", height: "2em",
                action: function() {
                    GameState.subState = GameSubState.PLAYING;
                }},
            {type: "button", text: "Restart", width: "20em", height: "2em",
                action: function() {
                    changeLevel(gameSettings.levelIndex);
                    GameState.subState = GameSubState.PLAYING;
                    GameState.counter1 = 0;
                }},
            {type: "button", text: "Select Track", width: "20em", height: "2em",
                action: function() {
                    GameState.subState = GameSubState.SHOWING_LEVEL_INTRO;
                    GameState.counter1 = 0;
                }},
            {type: "button", text: "Main Menu", width: "20em", height: "2em",
                action: function() {
                    GameState.subState = GameSubState.SHOWING_GAME_MENU;
                    GameState.counter1 = 0;
                }}
    ...
    MenuInfos[Menus.PLAY_MENU] = {
        caption: "Select Track",
        extra: [titleExtra],
        components: [
            {type: "object", object: gameSettings,
                changeListeners: [
                    function() {
                        gameSettings.saveToLocalStorage();
                    }],
                fontSize: "1em"},
            {type: "button", text: "GO!", width: "12em", height: "2em",
                action: function() {
//                    logit("Changing level " + gameSettings.levelIndex);
                    changeLevel(gameSettings.levelIndex);
                    GameState.subState = GameSubState.PLAYING;
                    GameState.counter1 = 0;
                }},
            {type: "button", text: "Main Menu", width: "12em", height: "2em",
                action: function() {
                    GameState.subState = GameSubState.SHOWING_GAME_MENU;
                    GameState.counter1 = 0;
                }},
...
//                    }
    ...
    MenuInfos[Menus.GAME_COMPLETE] = {
        caption: "All Tracks Completed!",
        extra: [titleExtra],
        components: [
//            {type: "text", texts: ["", "More info..."], width: "10em"},
            {type: "button", text: "OK!", width: "10em", height: "2em",
                action: function() {
                    GameState.counter1 = 0;
                    GameState.subState = GameSubState.SHOWING_GAME_MENU;
//                    changeLevel(0);
...
function showMenu(id) {
    ...
    if (menuInfo.extra) {
        var $topDiv = $("#topdiv");
        for (var i=0; i<menuInfo.extra.length; i++) {
            var extra = menuInfo.extra[i];
            var extraStr = extra.html;
            if (isArray(extra.html)) {
                extraStr = extra.html.join("");
            }
            var $extra = $(extraStr);
            $extra.css("font-size", scaler * extra.defaultFontSize + "px");
            $componentsDiv.append($extra);
        }
    }
    ...
    var menuFontSize = Math.ceil(30 * scaler);
    ...
    if (GameState.subStateChanged || force) {
        ...
        switch (GameState.subState) {
            ...
            case GameSubState.SHOWING_SETTINGS_MENU:
                ...
                break;
            case GameSubState.SHOWING_ABOUT_MENU:
                showMenu(Menus.ABOUT_MENU);
                break;
