...
CanvasRenderer3D.prototype.getPlayerShipBodyMaterial = function() {
    return new THREE.MeshBasicMaterial({color: 0xaaaaaa, emissive: 0x442222});
};

CanvasRenderer3D.prototype.getChopperBodyMaterial = function() {
    return new THREE.MeshBasicMaterial({color: 0777733, emissive: 0x333322});
};

CanvasRenderer3D.prototype.getChopperBossMaterial = function() {
    return new THREE.MeshBasicMaterial({color: 0xff2222, emissive: 0x441111});
};

CanvasRenderer3D.prototype.getPowerupMaterial = function(color, emissive) {
    return new THREE.MeshBasicMaterial({color: color, emissive: emissive});
};

CanvasRenderer3D.prototype.getDefenceTowerMaterial = function() {
    return new THREE.MeshBasicMaterial({color: 0x444444, emissive: 0x111111});
};

CanvasRenderer3D.prototype.getDefenceTowerBossMaterial = function() {
    return new THREE.MeshBasicMaterial({color: 0xff4444, emissive: 0x441111});
};

CanvasRenderer3D.prototype.getHouse1Material = function() {
    return new THREE.MeshBasicMaterial({color: 0x666666, emissive: 0x222222});
};


CanvasRenderer3D.prototype.getHouse2Material = function() {
    return new THREE.MeshBasicMaterial({color: 0x884444, emissive: 0x332222});
};


CanvasRenderer3D.prototype.getCannonBulletMaterial = function() {
    return new THREE.MeshBasicMaterial({color: 0xff0000, emissive: 0x660000});
};

CanvasRenderer3D.prototype.getBombMaterial = function() {
    return new THREE.MeshBasicMaterial({color: 0xffff00, emissive: 0x666600});
};


CanvasRenderer3D.prototype.getGroundMaterial = function(texture) {
    return new THREE.MeshBasicMaterial( { color: 0x222222, map: texture } );
};
