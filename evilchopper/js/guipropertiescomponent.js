...
//    this.createValueTypeRadioButtons($localRoot);
    ...
    this.$errorLabel.css("padding-left", "1em");
    ...
    //    }
    this.$label.css("padding-right", "1em");
    this.$input.css("width", "5em");
...
GuiPropertyRadioButtonsComponent.prototype.jQueryCreated = function($localRoot) {
    ...
    this.$label.css("padding-right", wantedLabelPaddingRight + "px");
...
//    logit("New value: " + JSON.stringify(list) + "<br />");
};
