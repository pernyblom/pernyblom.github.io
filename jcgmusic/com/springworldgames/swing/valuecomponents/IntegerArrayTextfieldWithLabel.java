...
public class IntegerArrayTextfieldWithLabel extends ValueComponent {

	boolean allowJavascript = false;
	...
	public IntegerArrayTextfieldWithLabel(String propertyName, String caption,
			int[] startValue, boolean checkElementValue, int minValue,
			int maxValue, boolean checkArity, int minArity, int maxArity) {
		super(propertyName);
	...
	public IntegerArrayTextfieldWithLabel(String propertyName,
	...
	public void validateText() {
		...
		try {
			int[] testValue = ParseUtils.parseIntArr(text);
			setIfValid(testValue, false);
		} catch (NumberFormatException e) {
			boolean ok = false;
			int [] testValue = null;
			if (ok) {
				setIfValid(testValue);
			} else {
